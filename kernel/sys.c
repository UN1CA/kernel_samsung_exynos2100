...
#define FAKE_UNAME_RELEASE "5.4.200"
#elif defined(CONFIG_FAKE_UNAME_5_10)
#define FAKE_UNAME_RELEASE "5.10.200"
#elif defined(CONFIG_FAKE_UNAME_5_15)
#define FAKE_UNAME_RELEASE "5.15.200"
#elif defined(CONFIG_FAKE_UNAME_6_1)
#define FAKE_UNAME_RELEASE "6.1.200"
#elif defined(CONFIG_FAKE_UNAME_6_6)
#define FAKE_UNAME_RELEASE "6.6.200"
#elif defined(CONFIG_FAKE_UNAME_6_12)
#define FAKE_UNAME_RELEASE "6.12.200"
#endif
		if (current_uid().val == 0) {
			#ifdef FAKE_UNAME_RELEASE
				strscpy(tmp.release, FAKE_UNAME_RELEASE, sizeof(tmp.release));
			#endif
